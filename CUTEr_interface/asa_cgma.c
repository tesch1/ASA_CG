...
/*      CParm.PrintLevel = 4 ;*/
        ...
        status = asa_cg (x, lo, hi, CUTEr_nvar, &Stat, &CParm, &AParm, 1.e-6,
                         asa_value, asa_grad, asa_valgrad, NULL, NULL) ;
        ...
        printf ("%10s %6i %7i %7i %7i %5i %16.7e %16.7e %9.3f\n",
            pname, CUTEr_nvar, Stat.cgiter+Stat.cbbiter, Stat.cgfunc+Stat.cbbfunc,
            Stat.cggrad+Stat.cbbgrad, status, Stat.pgnorm, Stat.f, cpu [1]) ;
